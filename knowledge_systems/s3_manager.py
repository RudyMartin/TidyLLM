...
# Import official UnifiedSessionManager from proper location
try:
...
logger = logging.getLogger("knowledge_systems_s3_manager")
...
class S3Manager:
    ...
    def __init__(self, config: S3Config = None, auto_discover: bool = True):
        ...
        if not UNIFIED_SESSION_AVAILABLE:
            raise ImportError("UnifiedSessionManager required for S3Manager")
        ...
        logger.info("✅ S3Manager initialized with UnifiedSessionManager")
