...
class DemoConnectionManager:
    ...
    def _load_config(self) -> ConnectionConfig:
        ...
        return ConnectionConfig(
            ...
            database=os.getenv('DEMO_DB_NAME', 'demo_db'),
            username=os.getenv('DEMO_DB_USER', 'demo_user'),
            password=os.getenv('DEMO_DB_PASSWORD', ''),
            pool_size=int(os.getenv('DEMO_DB_POOL_SIZE', '5')),
            timeout=int(os.getenv('DEMO_DB_TIMEOUT', '30')),
            ssl_mode=os.getenv('DEMO_DB_SSL_MODE', 'prefer')
        )
