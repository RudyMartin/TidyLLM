...
class PromptPipelineErrorTracker:
    ...
    def _has_business_impact(self, error_data: Dict[str, Any]) -> bool:
        ...
        # High cost impact
        cost_usd = error_data.get("cost_usd", 0)
        if cost_usd is not None and cost_usd > 50:
            return True
        ...
        # Performance impact
        response_time = error_data.get("response_time_ms", 0)
        if response_time is not None and response_time > 10000:
            return True
