...
Enterprise-grade gateway that routes all language model requests through 
corporate IT infrastructure with comprehensive governance, security, and 
compliance controls.

Purpose: Provides centralized control over AI/LLM usage including:
- Zero direct external API access (all requests go through corporate infrastructure)
