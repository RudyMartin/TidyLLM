...
class GatewayRegistry:
    ...
    Service Hierarchy:
    1. CorporateLLMGateway - Base control layer (no dependencies)
    2. AIProcessingGateway - AI model selection and routing (requires corporate_llm)
    3. WorkflowOptimizerGateway - Workflow analysis and optimization (requires ai_processing + corporate_llm)
    4. KnowledgeResourceServer - Context and knowledge provision (independent MCP server)
