...
Analyzes, optimizes, and fixes workflow definitions to ensure they run
efficiently and comply with standards.

Purpose: Acts as an intelligent workflow consultant that:
- Identifies bottlenecks and inefficiencies
- Suggests performance optimizations
- Fixes common workflow errors
