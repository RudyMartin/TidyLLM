...
json_folder_widget = widgets.Text(description="JSON Folder:", placeholder="json_chunks")
index_folder_widget = widgets.Text(description="Index Folder:", placeholder="faiss_index")
...
nlist_widget = widgets.IntText(description="nlist:", value=512)
nprobe_widget = widgets.IntText(description="nprobe:", value=16)
num_training_samples_widget = widgets.IntText(description="Training size:", value=1000)
