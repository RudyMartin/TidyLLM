#!/usr/bin/env python3
"""
TidyLLM DSPy Coordinated RAG System Demo Launcher
Smart launcher for DSPy-coordinated RAG system demonstration
...
c) Dynamic Port Assignment:
   - NO hardcoded ports - scan from 8513 upward for available port
...
NOTE: This demo may have TFIDFModel iteration issues that need resolution
"""
...
class RAGDSPyLauncher:
    """Smart launcher for DSPy Coordinated RAG demo"""
    
    def __init__(self):
        self.app_file = "tidyllm/examples/dspy_coordinated_rag_system.py"
        self.system = platform.system().lower()
        self.process = None
        self.port = None
        self.host = "0.0.0.0"
        
    def find_available_port(self, start_port: int = 8513) -> int:
            ...
            for proc in psutil.process_iter(['pid', 'name', 'cmdline']):
                try:
                    ...
                    if cmdline and any('streamlit' in arg.lower() for arg in cmdline):
                        if (any('dspy' in arg.lower() for arg in cmdline) or 
                            any('coordinated' in arg.lower() for arg in cmdline) or
                            any('8513' in arg for arg in cmdline) or
                            any('dspy_coordinated_rag_system.py' in arg for arg in cmdline)):
    ...
    def check_dependencies(self):
        ...
        required_packages = ['streamlit', 'numpy', 'typing', 'datetime']
        missing_packages = []
        ...
        print("WARNING: DSPy demo may have TFIDFModel iteration issues")
        return True
    ...
    def launch_streamlit(self):
        ...
        print("Starting DSPy Coordinated RAG Demo...")
        print(f"URL: http://localhost:{self.port}")
        print(f"External access: http://{self.get_local_ip()}:{self.port}")
        print("WARNING: May encounter TFIDFModel iteration errors")
    ...
    def monitor_process(self):
        ...
        print("\n" + "="*60)
        print("DSPY COORDINATED RAG DEMO - RUNNING")
        print("Features: DSPy Framework, Coordinated Components, Advanced RAG")
        ...
        try:
            ...
            print("\nShutting down DSPy Coordinated RAG Demo...")
            self.cleanup()
    ...
    def full_launch(self):
        ...
        print("TidyLLM DSPy Coordinated RAG Demo Launcher")
        print("=" * 50)
        print(f"System: {platform.system()} {platform.release()}")
        print(f"Python: {sys.version.split()[0]}")
        print(f"App: DSPy Coordinated RAG System")
        print("=" * 50)
        ...
        print(f"Demo Type:     DSPy Coordinated RAG System")
        print("=" * 60)
