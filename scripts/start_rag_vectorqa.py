#!/usr/bin/env python3
"""
TidyLLM VectorQA Simple RAG Demo Launcher
Smart launcher for VectorQA-based simple RAG demonstration
...
c) Dynamic Port Assignment:
   - NO hardcoded ports - scan from 8512 upward for available port
...
class RAGVectorQALauncher:
    """Smart launcher for VectorQA Simple RAG demo"""
    
    def __init__(self):
        self.app_file = "tidyllm-vectorqa/tidyllm_vectorqa/whitepapers/simple_rag_demo.py"
        self.system = platform.system().lower()
        self.process = None
        self.port = None
        self.host = "0.0.0.0"
        
    def find_available_port(self, start_port: int = 8512) -> int:
            ...
            for proc in psutil.process_iter(['pid', 'name', 'cmdline']):
                try:
                    ...
                    if cmdline and any('streamlit' in arg.lower() for arg in cmdline):
                        if (any('vectorqa' in arg.lower() for arg in cmdline) or 
                            any('simple_rag' in arg.lower() for arg in cmdline) or
                            any('8512' in arg for arg in cmdline) or
                            any('simple_rag_demo.py' in arg for arg in cmdline)):
    ...
    def launch_streamlit(self):
        ...
        print("Starting VectorQA Simple RAG Demo...")
    ...
    def monitor_process(self):
        ...
        print("\n" + "="*60)
        print("VECTORQA SIMPLE RAG DEMO - RUNNING")
        print("Features: PDF Processing, Semantic Search, Paper-based QA")
        ...
        try:
            ...
            print("\nShutting down VectorQA Simple RAG Demo...")
            self.cleanup()
    ...
    def full_launch(self):
        ...
        print("TidyLLM VectorQA Simple RAG Demo Launcher")
        print("=" * 50)
        print(f"System: {platform.system()} {platform.release()}")
        print(f"Python: {sys.version.split()[0]}")
        print(f"App: VectorQA Simple RAG")
        print("=" * 50)
        ...
        print(f"Demo Type:     VectorQA Simple RAG")
        print("=" * 60)
