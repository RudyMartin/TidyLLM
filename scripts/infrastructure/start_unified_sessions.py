...
class UnifiedSessionManager:
    ...
    def _load_from_environment(self):
        ...
        if postgres_password:
            ...
            logger.info("✅ Found PostgreSQL password in environment")
        ...
        for path in settings_paths:
            if path.exists():
                try:
                    ...
                    logger.warning(f"⚠️  Could not load settings from {path}: {e}")
    ...
    def _init_s3(self):
        ...
        try:
            ...
            logger.info(f"✅ S3 connection established ({latency:.1f}ms)")
    ...
    def _init_bedrock(self):
        ...
        try:
            ...
            logger.info(f"✅ Bedrock connection established ({latency:.1f}ms)")
    ...
    def _init_postgresql(self):
        ...
        try:
            ...
            logger.info(f"✅ PostgreSQL connection established ({latency:.1f}ms)")
