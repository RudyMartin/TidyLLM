...
class EnhancedDropZonesWithCleanup(FileSystemEventHandler):
    ...
    def setup_directories(self):
        ...
        Path(build_s3_path("knowledge_base", "processed")).mkdir(parents=True, exist_ok=True)
        Path(build_s3_path("knowledge_base", "embeddings")).mkdir(parents=True, exist_ok=True)
        Path(build_s3_path("knowledge_base", "pdfs")).mkdir(parents=True, exist_ok=True)
...
"""
    ...
    def move_to_processed(self, file_path):
        ...
        dest_path = Path(build_s3_path("knowledge_base", "processed")) / dest_name
