#!/usr/bin/env python3
"""
TidyLLM RAG Polars Demo Launcher
Smart launcher for Polars-based RAG demonstration
...
c) Dynamic Port Assignment:
   - NO hardcoded ports - scan from 8510 upward for available port
...
class RAGPolarsLauncher:
    """Smart launcher for RAG Polars demo"""
    
    def __init__(self):
        self.app_file = "tidyllm/examples/rag_demo_polars.py"
        self.system = platform.system().lower()
        self.process = None
        self.port = None
        self.host = "0.0.0.0"
        
    def find_available_port(self, start_port: int = 8510) -> int:
                ...
                try:
                    ...
                    if cmdline and any('streamlit' in arg.lower() for arg in cmdline):
                        if (any('rag' in arg.lower() for arg in cmdline) or 
                            any('8510' in arg for arg in cmdline) or
                            any('rag_demo_polars.py' in arg for arg in cmdline)):
    ...
    def launch_streamlit(self):
        ...
        print("Starting RAG Polars Demo...")
    ...
    def monitor_process(self):
        ...
        print("\n" + "="*60)
        print("RAG POLARS DEMO - RUNNING")
        print("Features: Polars DataFrames, Vector Operations, Fast Filtering")
    ...
    def full_launch(self):
        ...
        print("TidyLLM RAG Polars Demo Launcher")
        print("=" * 50)
        print(f"System: {platform.system()} {platform.release()}")
        print(f"Python: {sys.version.split()[0]}")
        print(f"App: RAG with Polars DataFrames")
        print("=" * 50)
        ...
        print(f"Demo Type:     RAG with Polars DataFrames")
        print("=" * 60)
