...
try:
    from tidyllm.infrastructure.tools.json_scrubber import safe_load_json_with_scrubbing
...
class TemplateFieldExtractor:
    ...
    def generate_field_definitions_json(self) -> str:
        """Generate JSON schema for extracted fields"""
        ...
        for field in result.fields:
            schema["template_fields"][field.name] = {
