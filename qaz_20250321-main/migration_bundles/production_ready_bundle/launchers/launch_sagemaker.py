#!/usr/bin/env python3
"""
Sagemaker Environment Launcher

Launches the VectorQA application optimized for sagemaker environment.
"""
...
def setup_sagemaker_environment():
    """Setup sagemaker-specific environment"""
    # Set environment variable
    os.environ["VECTORQA_ENV"] = "sagemaker"
    
    # Setup Python path for sagemaker
